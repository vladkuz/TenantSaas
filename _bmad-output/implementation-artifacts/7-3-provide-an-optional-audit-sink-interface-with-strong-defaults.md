...
2. Given a custom audit sink is provided
...
- [ ] Introduce optional audit sink extension seam with strict default behavior (AC: 1)
  - [ ] Add/extend `IBreakGlassAuditSink` (or equivalent) as optional interface boundary
  - [ ] Keep default sink behavior contract-compliant when no custom sink is configured
- [ ] Enforce required audit field preservation for custom sinks (AC: 2)
  - [ ] Validate actor/reason/scope/target/trace/invariant data is never dropped
  - [ ] Define fallback/refusal behavior when custom sink cannot satisfy contract
- [ ] Add compliance tests for default and custom sink paths (AC: 1, 2)
  - [ ] Assert required fields for default emissions
  - [ ] Assert required fields remain intact through custom sink integration
...
- _bmad-output/implementation-artifacts/7-3-provide-an-optional-audit-sink-interface-with-strong-defaults.md
- _bmad-output/implementation-artifacts/sprint-status.yaml

### References

- [Source: _bmad-output/planning-artifacts/epics.md#Story 7.3: Provide an Optional Audit Sink Interface with Strong Defaults]
